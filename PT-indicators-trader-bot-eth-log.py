...
class DiscordLogNotifier:
    ...
    async def _send_discord_notification(self, title, message, color=0xFF00FF ):
        """
...
class AdvancedTradingBot:
    ...
    async def send_discord_notification(self, title: str, message: str, color: int = 0xFF00FF ):
        ...
        try:
            ...
            if not position["trailing_stop_activated"] and self.risk_manager.should_activate_trailing_stop(position, current_price):
                ...
                await self.send_discord_notification(
                    ...
                    0xFF00FF  if position['side'] == 'long' else 0xff0000
                )
    ...
    async def log_and_notify(self, level: str, title: str, message: str, color: int = 0xFF00FF ):
